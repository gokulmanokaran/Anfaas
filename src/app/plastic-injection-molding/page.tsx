...
const products = [
  ...
  return {
    name,
    src: `/plastic%20injection%20molding%20machine/${filename}`,
  };
});

export default function PlasticInjectionMoldingPage() {
  return (
      ...
      <section className="relative py-20 bg-white border-b border-zinc-200">
        ...
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8 relative z-10 text-center">
          <motion.h1 
            ...
            className="text-4xl md:text-5xl font-black text-zinc-900 mb-6 leading-tight"
          >
            Plastic Injection <span className="text-red-600">Molding Machines</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Discover our high-precision plastic injection molding solutions, designed for unmatched efficiency, reliability, and superior part quality.
          </motion.p>
        </div>
      </section>
