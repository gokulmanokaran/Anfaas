...
import { CheckCircle2, Droplets, ShieldCheck, Zap, FileText, Download } from "lucide-react";
import Link from "next/link";

const specifications = [
  { label: "Viscosity Index", value: "VI 110-160", icon: Droplets },
  { label: "Grade Range", value: "ISO VG 32-460", icon: ShieldCheck },
  { label: "Base Oil", value: "Synthetic / Mineral", icon: Zap },
];

const features = [
  "Superior anti-wear protection for extended component life",
  "Excellent thermal and oxidation stability in extreme temperatures",
  "High resistance to foaming and aeration for consistent power",
  "Compatible with common seal materials to prevent leaks",
];
...
export default function LubricantsContent() {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-28 pb-16 lg:pt-40 lg:pb-32 px-6 lg:px-8 max-w-[1400px] mx-auto w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        >
          <motion.div variants={fadeIn}>
            ...
            <h2 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-zinc-900 tracking-tight leading-[1.1]">
              Industrial <br />
              <span className="text-red-600">Lubricants</span>
            </h2>
          </motion.div>

          <motion.p variants={fadeIn} className="text-base sm:text-lg text-zinc-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
            Maximize your machinery&apos;s potential with our high-performance industrial oils and specialty greases. Engineered for durability, efficiency, and extreme protection.
          </motion.p>

          <motion.div variants={fadeIn} className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <a
              href="/lubricant-specs.pdf"
              download
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-red-600 text-white font-bold shadow-[0_8px_32px_rgba(220,38,38,0.25)] hover:bg-red-700 hover:-translate-y-1 transition-all duration-300"
            >
        ...
        <motion.div
          ...
          className="flex-1 w-full grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-4"
        >
          {/* Drum 1 */}
          <div className="relative aspect-[3/4] bg-zinc-50 rounded-3xl overflow-hidden shadow-lg border border-zinc-100 group">
            <Image
              src="/drum1.jpg"
              alt="Industrial Lubricant Drum 1"
              fill
          ...
          {/* Drum 2 */}
          <div className="relative aspect-[3/4] bg-zinc-50 rounded-3xl overflow-hidden shadow-lg border border-zinc-100 group mt-8 lg:mt-12">
            <Image
              src="/drum2.jpg"
              alt="Industrial Lubricant Drum 2"
              fill
              sizes="(max-width: 640px) 100vw, 300px"
              className="w-full h-full object-contain p-4 group-hover:scale-110 transition-transform duration-700"
            />
      ...
      <section id="specs" className="py-20 lg:py-32 bg-zinc-50 relative">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
          ...
          >
            <h3 className="text-3xl sm:text-5xl font-bold text-zinc-900 mb-6">Technical Excellence</h3>
            <p className="text-base sm:text-lg text-zinc-600 leading-relaxed">Our lubricants are formulated to meet the most stringent OEM requirements and industrial standards.</p>
          </motion.div>
          ...
          <div className="bg-zinc-900 rounded-[2.5rem] sm:rounded-[4rem] p-8 sm:p-16 lg:p-24 overflow-hidden relative shadow-[0_32px_80px_rgba(0,0,0,0.2)]">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 relative z-10 items-center">
              <div className="space-y-8">
                <h4 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight">Performance Benefits</h4>
              ...
              <div className="relative pt-8 lg:pt-0">
                <div className="w-full bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-8 sm:p-12 flex flex-col items-center justify-center text-center space-y-6 sm:space-y-8">
                  ...
                  <div className="space-y-2">
                    <h5 className="text-xl sm:text-2xl font-bold text-white">Technical Data Sheet</h5>
                    <p className="text-zinc-400 text-sm sm:text-base max-w-[280px] mx-auto leading-relaxed">Get full technical specifications and chemical properties.</p>
                  </div>
                  <a
                    href="/lubricant-specs.pdf"
                    download
                    className="w-full py-4 rounded-xl bg-white text-zinc-900 font-bold hover:bg-zinc-100 transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    <Download className="w-5 h-5" />
                    Download PDF
                  </a>
